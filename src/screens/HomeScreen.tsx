...
// ---------------------------------------------------------------------------
// Weather stat widgets
// ---------------------------------------------------------------------------
const statWidgets: Array<{ type: WeatherStatType; value: string; description?: string }> = [
...
function HouseIllustration() {
  return (
    ...
    >
      ...
      {/* Left window */}
      <rect
        x="72" y="72" width="42" height="30"
        rx="3"
        fill="rgba(255,230,100,0.10)"
        stroke="rgba(255,255,255,0.18)"
        strokeWidth="1"
      />
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(ellipse, rgba(100,80,210,0.55) 0%, transparent 65%)',
          filter: 'blur(24px)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(ellipse, rgba(64,203,216,0.22) 0%, transparent 70%)',
          filter: 'blur(32px)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(ellipse, rgba(72,49,157,0.18) 0%, transparent 70%)',
          filter: 'blur(40px)',
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        >
          <button
            ...
            style={{
              ...
              color:
                activeTab === 'hourly' ? '#FFFFFF' : 'rgba(235,235,245,0.4)',
              background: 'none',
              border: 'none',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              ...
              color:
                activeTab === 'weekly' ? '#FFFFFF' : 'rgba(235,235,245,0.4)',
              background: 'none',
              border: 'none',
              cursor: 'pointer',
              transition: 'color 250ms ease',
        ...
        {/* ── MEDIUM WEATHER WIDGET BAR (Air Quality) ─────────────── */}
        <div
          style={{
            margin: '0 16px 20px',
            borderRadius: 16,
